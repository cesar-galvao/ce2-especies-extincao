...
nomes <- read.csv('especies_2020.csv', sep = ';', encoding = 'UTF-8', header = FALSE, nrows = 1)
...
#producao de arquivo final ----
write.csv(especies_2020_pronto, './data/especies_2020_pronto.csv')
